...
CREATE TABLE IF NOT EXISTS `hotel_booking_test`.`user` (
  ...
  `balance` DECIMAL(19,4) NOT NULL DEFAULT 0 COMMENT 'Баланс пользователя. Был выбран тип DECIMAL так как он самый точный, а при работе с деньгами должна быть большая точность',
...
CREATE TABLE IF NOT EXISTS `hotel_booking_test`.`apartment_class` (
  ...
  `cost_per_night` DECIMAL(19,4) NOT NULL COMMENT 'Стоимость номера за ночь',
  `cost_per_person` DECIMAL(19,4) NOT NULL COMMENT 'Стоимость одного спального места в номере',
...
CREATE TABLE IF NOT EXISTS `hotel_booking_test`.`reservation` (
  ...
  `cost_per_person` DECIMAL(19,4) NOT NULL COMMENT 'Стоимость одного спального места, была введена так как стоимость спального места может измениться после бронирования, а пользователь уже заплатил за него конкретную цену',
  `cost_per_night` DECIMAL(19,4) NOT NULL COMMENT 'Стоимость номера за одну ночь, была введена так как стоимость номера может измениться после бронирования, а пользователь уже заплатил за него конкретную цену',
  `total_cost` DECIMAL(19,4) NOT NULL COMMENT 'Полная стоимость номера, введена для сокращения времени на расчет цены, так как она используеться во многих местах ',
...
START TRANSACTION;
USE `hotel_booking_test`;
INSERT INTO `hotel_booking_test`.`user` (`id_user`, `first_name`, `middle_name`, `last_name`, `balance`, `email`, `phone_number`, `password`, `role_id_fk`, `active`) VALUES (1, 'Vadim', 'Alekseevich', 'Martyniuk', 1000, 'konkord321@gmail.com', '+375257473147', '1234567890', 1, 1);
INSERT INTO `hotel_booking_test`.`user` (`id_user`, `first_name`, `middle_name`, `last_name`, `balance`, `email`, `phone_number`, `password`, `role_id_fk`, `active`) VALUES (2, 'Ivan', 'Ivanovich', 'Ivanov', 100, 'ivanov@gmail.com', '+375291234567', '0987654321', 2, 1);
INSERT INTO `hotel_booking_test`.`user` (`id_user`, `first_name`, `middle_name`, `last_name`, `balance`, `email`, `phone_number`, `password`, `role_id_fk`, `active`) VALUES (3, 'Petr', 'Petrovich', 'Petrov', 0, 'petrov@gmail.com', '+375297654321', '1111111111', 2, 1);
INSERT INTO `hotel_booking_test`.`user` (`id_user`, `first_name`, `middle_name`, `last_name`, `balance`, `email`, `phone_number`, `password`, `role_id_fk`, `active`) VALUES (4, 'Aleksei', 'Alekseevich', 'Alekseev', 500, 'alekseev@gmail.com', '+375440904312', '2222222222', 2, 0);
...
START TRANSACTION;
USE `hotel_booking_test`;
INSERT INTO `hotel_booking_test`.`apartment` (`id_apartment`, `number`, `floor`, `apartment_class_id_fk`, `active`) VALUES (1, '201', 2, 2, 1);
INSERT INTO `hotel_booking_test`.`apartment` (`id_apartment`, `number`, `floor`, `apartment_class_id_fk`, `active`) VALUES (2, '204', 2, 1, 1);
INSERT INTO `hotel_booking_test`.`apartment` (`id_apartment`, `number`, `floor`, `apartment_class_id_fk`, `active`) VALUES (3, '301', 3, 3, 1);
INSERT INTO `hotel_booking_test`.`apartment` (`id_apartment`, `number`, `floor`, `apartment_class_id_fk`, `active`) VALUES (4, '307', 3, 2, 1);
INSERT INTO `hotel_booking_test`.`apartment` (`id_apartment`, `number`, `floor`, `apartment_class_id_fk`, `active`) VALUES (5, '406', 4, 2, 1);
...
START TRANSACTION;
USE `hotel_booking_test`;
INSERT INTO `hotel_booking_test`.`reservation` (`id_reservation`, `check_in_date`, `check_out_date`, `order_time`, `person_amount`, `cost_per_person`, `cost_per_night`, `total_cost`, `user_id_fk`, `apartment_id_fk`, `status_id_fk`) VALUES (1, '2017-8-15', '2017-8-18', '2017-7-22 18:30:21', 2, 100, 200, 800, 2, 2, 3);
